        ...
        return (
          <Page key={index}>
            ...
            {/* {employee.description!=="" && (
                        ...
                        Extra information about this employee:{employee.description}
                        </Text>
                        )}
                        {employee.description=="" && (
                          <Text style={styles.page}>
                        Employee: {employee.firstName} {employee.lastName+"\n"}
                        No additional information, please reffer to you supervisor
                        </Text>
                        )} */}
            {employee.description !== "" ? (<Text style={styles.page}>
              Employee: {employee.firstName} {employee.lastName + "\n"}
              Extra information about this employee:{employee.description}
            </Text>) :
              (<Text style={styles.page}>
